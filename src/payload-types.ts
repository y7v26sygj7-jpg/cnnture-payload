...
export interface Product {
  ...
  /**
   * Herbal personality line, e.g. "Artemisia argyi · The Quiet One"
   */
  ...
  gallery?:
    ...
    | null;
  /**
   * Materials list, e.g. [{label: "材料", value: "真艾草叶 · 水晶树脂"}]
   */
  materials?:
    | {
        label?: string | null;
  ...
  /**
   * Title for the product story section
   */
  storyTitle?: string | null;
  /**
   * Product story / cultural background
   */
  story?: {
    root: {
      type: string;
...
export interface Footer {
  ...
  legalLinks?:
    ...
    | null;
  /**
   * Footer brand tagline, e.g. "东方草本器物品牌"
   */
